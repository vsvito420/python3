 ...
 * Handles basic formatting like paragraphs and converts Markdown tables to HTML tables.
 * NOTE: This is a basic parser. For full Markdown support, consider a library like Marked.js or Showdown.js.
 *       This implementation focuses on adding table support as requested.
 *
...
async function initializeApp() {
    ...
    try {
        ...
        const success = await loadAndParseMarkdown(mainPagePath);
...
window.loadAndParseMarkdown = loadAndParseMarkdown;
